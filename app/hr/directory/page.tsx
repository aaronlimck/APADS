  ...
  return (
    <div className="min-h-screen max-w-7xl mx-auto px-4 md:px-6 py-4">
      <div className="flex justify-between">
        <div className="mb-4">
          <h1 className="text-3xl font-semibold tracking-tight select-none">Directory</h1>
        </div>
        <div className="">
      ...
      <div className="flex">
        ...
        <Button className="border bg-white text-black hover:bg-gray-50 ml-4" >Filter</Button>
      </div>
      <div className="my-4">
